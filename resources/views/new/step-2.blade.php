...
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-7">
            ...
            <a href="#" class="text-sm font-medium text-current hover:text-pink transition-all duration-300">Sign out</a>
        </div>
        ...
        <div class="mt-8 relative md:block hidden">
            ...
            <div class="flex justify-center lg:space-x-24 space-x-12">
                <div>
                    <div class="mx-auto w-8	h-8 border border-pink rounded-full text-lg font-medium flex justify-center items-center text-pink bg-gray">1</div>
                    <div class="text-pink font-medium mt-2">Create plan</div>
                </div>
                <div>
                    <div class="mx-auto w-8	h-8 border border-gray-three rounded-full text-lg font-medium flex justify-center items-center text-gray-three bg-gray">2</div>
                    <div class="text-gray-three font-medium mt-2">Connect calendar </div>
                </div>
                <div>
                    <div class="mx-auto w-8	h-8 border border-gray-three rounded-full text-lg font-medium flex justify-center items-center text-gray-three bg-gray">3</div>
                    <div class="text-gray-three font-medium mt-2">Create promo page</div>
                </div>
                <div>
                    <div class="mx-auto w-8	h-8 border border-gray-three rounded-full text-lg font-medium flex justify-center items-center text-gray-three bg-gray">4</div>
        ...
        <div class="flex md:mt-12 mt-2 md:pb-12 pb-24">
            <div class="md:w-8/12 w-full md:pr-10">
                <div class="md:bg-white md:rounded-3xl md:shadow-md  md:p-8">
                    <div class="text-2xl font-medium">Create plan</div>
                    <div class="mt-4 text-sm font-medium">Create one or more meeting types</div>

                    <div class="relative border border-pink py-3 px-6 bg-pink-one rounded-lg mt-6">
                        <div class="absolute -right-2 top-2/4">
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.68872 2.94001C7.476 3.28113 7.476 4.71887 6.68872 5.05999L0.797851 7.61239V4V0.387606L6.68872 2.94001Z" fill="#E5005B"/>
                            </svg>
                        </div>
                        <div class="sm:w-80">
                            <label class="font-medium block text-sm">Call Duration</label>
                    ...
                    <div class="mt-6">
                        <label class="font-medium block text-sm">Add plan title</label>
                        <input class="mt-2 h-12 px-4 rounded-md border border-gray-two w-full outline-0 placeholder:text-gray-four text-pur-pure" type="text">
                    </div>

                    <div class="mt-6 sm:w-80">
                        <label class="font-medium block text-sm">Price</label>
                        <input class="mt-2 h-12 px-4 rounded-md border border-gray-two w-full outline-0 placeholder:text-gray-four text-pur-pure" type="text" placeholder="10.00 Eur">
                    </div>
                    ...
                    <div class="mt-10 flex items-center justify-between">
                        <button class="sm:hidden block opacity-0">
                            Back
                        </button>
            ...
            <div class="content-bottom w-4/12 px-6 sm:px-14 pb-10 md:p-0">
                ...
                <div class="mt-2 relative">
                    ...
                    <div class="pl-8 relative border-b-[rgba(182, 182, 182, 0.16)]">
                        ...
                        <div class="text-lg	font-medium">Add call duration</div>
                        <div class="mt-2 text-sm font-medium">Lorem ipsum dolor sit consectetur adipiscing elit. Nulla varius nisi vel.</div>
                    ...
                    <div class="mt-3 pl-8 relative ">
                        <div class="w-3	h-3 absolute left-0 rounded-full bg-gray-two top-2"></div>
                        <div class="text-lg	font-medium">Create promo page</div>
                        <div class="pt-3 border-b border-gray-two pl-5"></div>
                    </div>
                    <div class="mt-4 pl-8 relative">
                        <div class="w-3	h-3 absolute left-0 rounded-full bg-gray-two top-2"></div>
