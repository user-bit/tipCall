    ...
    <main>
        ...
        <div class="md:pt-8 pt-4 bg-gray">
            <div class="container mx-auto px-4">
                ...
                <div class="mt-5 mx-auto w-3/5 text-center">
                    <p>Your profile is public. Here's the unique public link:</p>
                ...
                <form class="pb-12">
                    ...
                    <div class="flex justify-center mt-12">
                        ...
                        <button type="submit" class="mx-2 text-white bg-pur-pure border border-pur-pure rounded-full font-medium px-6 py-2 tracking-wider hover:bg-transparent hover:text-current transition-all duration-300">Make public</button>
                    </div>
                </form>
