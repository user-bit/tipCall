...
<div class="dashboard-menu md:pt-6 pt-2 bg-white">
    <div class="container mx-auto px-4 overflow-auto sm:pb-0 pb-2">
        <ul class="flex justify-start min-w-max">
            ...
            <li class="py-3 mr-8 <?php echo ($_SERVER['REQUEST_URI']=='/calendar-import')?'border-b-2 border-b-current':''?>">
                <a href="{{ url('calendar-import') }}" class="<?php echo ($_SERVER['REQUEST_URI']=='/calendar-import')?'font-semibold':'hover:text-pink transition-all duration-300'?>">Calendar</a>
            </li>
        </ul>
    </div>
</div>
