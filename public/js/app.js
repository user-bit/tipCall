...
window.addEventListener("load", function () {
  if (document.querySelector(".open-menu") !== null) {
    document.querySelector(".open-menu").addEventListener('click', function (_ref) {
